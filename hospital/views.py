...
#for showing signup/login button for admin(by sultan)
...
#for showing signup/login button for doctor(by sultan)
...
#for showing signup/login button for patient(by sultan)
...
#-----------for checking user is doctor , patient or admin(by sultan)
def is_admin(user):
